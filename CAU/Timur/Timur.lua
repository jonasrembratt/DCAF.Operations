...
Timur.Messages = {
    ...
    RequestSensors = "[CALLSIGN] with top priority tasking. We need sensors on the target in Sukhumi as soon as possible. We need verification on "..
                     "whether that civilian building might have been hit by mistake. The building is a fifteen story residential building in gd[".._name .. " RP]."..
