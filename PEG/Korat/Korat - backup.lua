...
-- function Korat:_onSuperiorThreat(caps, threat)
--     local airGroups = {}
--     for _, capInfo in ipairs(caps) do
...
-- function Korat:OnSuperiorThreat(airGroups, threat)
--     -- NOTE -- this function is 
--     for _, airGroup in ipairs(airGroups) do
-- Debug("nisse - Korat:OnSuperiorThreat // scram :: airGroup: " .. DumpPretty(airGroup))
