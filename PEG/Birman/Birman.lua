...
function Birman:GraveyardShift()
    ...
    Birman._heli_option = Birman._main_menu:AddCommand("Muninn 1 Proceed", function()
        SetFlag("_heli_continue")
        Divert(Birman.Groups.BLU.Valkyrie2, "PROCEED")
        -- Birman._heli_option:Remove()
        Birman:RemoveMenu(Birman._heli_option)
        Birman:RemoveMenu(Birman._engage_checkpoint)
        Birman._goblin_menu = Birman._main_menu:AddCommand("Disembark Fenris", function()
